package com.simplify.jobsboard.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.simplify.jobsboard.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.simplify.jobsboard.repository.UserRepository.USERS_BY_EMAIL_CACHE);
